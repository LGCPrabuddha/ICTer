            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Publicity Handling <span class="fa fa-chevron-down"></span></a>
                  </li>
                  ...
                  <li><a><i class="fa fa-table"></i> Committee Member Details <span class="fa fa-chevron-down"></span></a></li>
          ...
          <div class="left-main">
            ...
            <?php echo date("d/m/y"); ?></h1> 
              ...
              <div class="process" id="process-heading">
                <h3>Publicity Handling</h3>
              </div>    
              
              <div class="process" id="process-body">
                <a href=""><h4>Progess of Publicity Handling</h4></a>
                <div class="progress">
