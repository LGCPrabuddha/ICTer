...
<html lang="en">
  ...
  <body class="nav-md" style="height: 2000px;">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="Edit3.1p.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-edit"></i> Committee <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Assiging Task To Member<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="mem3.1p.php">Udara</a></li>
                      <li><a href="media_gallery.html">pathum</a></li>
                      <li><a href="typography.html">rishoban</a></li>
                      <li><a href="icons.html">dulmini</a></li>
                      <li><a href="glyphicons.html">bala bala</a></li>
                      <li><a href="widgets.html">bala bala</a></li>
                      <li><a href="invoice.html">bala bala</a></li>
                      <li><a href="inbox.html">bala bala</a></li>
                      <li><a href="calendar.html">bala bala</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-table"></i> Committee Details <span class="fa fa-chevron-down"></span></a></li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="left-main">
            ...
            <?php echo date("d/m/y"); ?></h1> 
              ...
              <div class="process" id="process-body" style="height: 1500px;">
                <a href=""><h4> Progess of Udara</h4></a>
                <div class="progress">
                   <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 65%; height: 20px;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">65%</div>
                   </div>


                <h3>View/Add Task Ditails</h3>
                ...
                <div class="task-center">
                  <form class="form-horizontal form-label-left">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" placeholder="Enter Task">
                    </div>
                  </form>
                ...
                <div class="task-center">
                  <form class="form-horizontal form-label-left">
                    <div class="form-group">
                      <label><h4>Enter the Due Date</h4></label>
                      <input type="email" class="form-control" placeholder="Enter Date" style="width: 25%">
                    </div>
                  </form>
                <button type="submit" class="btn btn-primary add">Add</button> 
                </div>
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          <td><label for="example">Task1</label></td>
                          <td><label>
                          <input type="radio" class="option-input radio" name="example" />
    
                          </label></td>
                          <td><input type="radio" class="option-input radio" name="example"/>
