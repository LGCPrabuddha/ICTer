...
<html lang="en">
  ...
  <body class="nav-md" style="height: 800px;">
          ...
          <div class="left-main">
            ...
            <?php echo date("d/m/y"); ?></h1> <!-- ccc -->
              ...
              <div class="process" id="process-body">
                 ...
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis eaque repellendus iusto sapiente, doloribus eum, voluptatem tempore nemo consequuntur quibusdam esse repudiandae est. Porro sit quisquam, voluptatum molestias tempora in.</p>
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia ratione voluptate officiis beatae non. Provident nemo eligendi ea amet magni natus magnam, delectus quisquam maxime dolor debitis ipsam, obcaecati facilis.</p>
                <form action="post" action="leader.php">
                 <p class="int">
                    <label for="" style="font-size: 30px; margin-left: 250px; margin-bottom: 10px">My Group :</label>   
                    <select name="l_type" style="width: 30%;  height: 30px; font-size: 20px; margin-top: 5px; margin-left: 5px; ">
                          ...
                          <option value="Accomodation">Accomodation Committee</option>
                          <option value="Refreshment">Refreshment Committee</option>
                          <option value="Bag">Conferens Bag Committee</option>
                          <option value="Publicity">Publicity Committee</option>
                          <option value="Keynote">Keynote Committee</option>
                          <option value="Sponsorship">Sponsorship Committee</option>
                        </select>
                  </p>
                  <div>
                    <button type="submit" name="submit" class="b1">Go My Page</button> 
