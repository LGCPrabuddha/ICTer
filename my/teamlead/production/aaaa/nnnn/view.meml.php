...
<?php 
  ...
  if (!isset($_SESSION['email'])){
    ...
    $admin_list = '';
    $query = "SELECT * FROM user WHERE profile_type= 'member' ORDER BY 'uaser_name' ";
    $members = mysqli_query($connection,$query);

    if ($members) {
      while ($member = mysqli_fetch_assoc($members)) {
        $admin_list .= "<tr style=\"font-size: 15px; color:#4d4d4d;\">";
        $admin_list .= "<td><label for=\"example\" class=\"option-input radio\">{$member['user_name']}</label></td>";
        $admin_list .= "<td><label for=\"example\" class=\"option-input radio\">{$member['email']}</label></td>";
        $admin_list .= "<td><label for=\"example\" class=\"option-input radio\">{$member['tele_no']}</label></td>";
        $admin_list .= "<td><label style=\"font-size: 15px;\" for=\"example\" class=\"option-input radio\"><a href=\"add_member.php?member_email={$member['email']}\">Add Member</a></label></td>";
        $admin_list .= "</tr>";
      }
    }else{
...
<html lang="en">
  ...
  <body class="nav-md" onload="startTime()" style="height: 1100px";>
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <h3 class="site_title"><i class="fa fa-paw"></i> <span>Admin</span></h3>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="profile.php"><i class="fa fa-edit"></i> Committee Details <span class="fa fa-chevron-down"></span></a></li>
                  <li><a href="wns.php"><i class="fa fa-desktop"></i> Assigning Task<span class="fa fa-chevron-down"></span></a></li>
                  <li><a href="bla"><i class="fa fa-table"></i> Committee Database <span class="fa fa-chevron-down"></span></a></li>
          ...
          <div class="left-main">
            ...
            <h1 id="txt"></h1> <!-- ccc -->
              ...
              <div class="process" id="process-heading">
                <h3>Member Details</span></h3>
              </div>    
              <h1> </h1>
              
              <div class="process" id="process-body" style="height: 700px" >

                <div>
                  <main>
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">

                      <thead class="process" id="process-heading">
                        <tr>
                          <th><h4>member name</h4></th>
                          <th><h4>Email</h4></th>
                          <th><h4>Telephone number</h4></th>
                          <th><h4>Add commette</h4></th>
                        </tr>
                      </thead>
