...
<?php 
  ...
  //checking if a user is login in
  ...
  if (isset($_REQUEST['member_email'])) {
    # getting the user informetion
    $m_email = mysqli_real_escape_string($connection, $_REQUEST['member_email']);
    $query = "SELECT * FROM user WHERE email = '{$m_email}' LIMIT 1"; 
    ...
    if ($result_set) {
      if (mysqli_num_rows($result_set)==1) {
        ...
        // user not found
        header('Location: view.meml.php?err=member_not_found');
      }
    }else{
      // user unsuccessful
      header('Location: view.meml.php?err=query_failed');
    }
  ...
  if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
      ...
      $query = "UPDATE admin SET password = '{$hashed_password}' WHERE id = {$admin_id} LIMIT 1"; 

      $result = mysqli_query($connection,$query);

      if ($result) {
        // query successfull.... redireting to modify-admin page
        header('Location:modify-admin.php?edit_admin=true');
      }else{
...
<html lang="en">
  ...
  <body class="nav-md" onload="startTime()" style="height: 835px";>
      ...
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="admin.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-edit"></i> Committee Details <span class="fa fa-chevron-down"></span></a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $_SESSION['first_name']; ?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="left-main">
            ...
            <h1>To Day: <!-- cccc -->
            <?php echo date("d/m/y"); ?></h1> 
            <h1 id="txt"></h1> <!-- ccc -->

              <div class="process" id="process-heading">
                <h3>Add/Delete Committe</span></h3>
              </div>    
              <h3><a href="view.meml.php"><< Go Back</a></h3>
              
              <div class="process" id="process-body" style="height: 485px" >
                <h3 style="margin-bottom: 40px;" class="enter">Member add/delete committe</h3>
              <main>
                <form action="add_member.php" method="post" class="userform">
                  ...
                  <p>
                    <label for="" class="enter_d">Full Name:</label>
                    <input type="text" name="name" class="input" <?php echo 'value="' .$name. '"'; ?> disabled>
                  </p>

                  <p>
                    <label for="" class="enter_d">Email:</label>
                    <input type="email" name="email" class="input" <?php echo 'value="' .$m_email. '"'; ?> disabled>
                  </p>

                  <p class="int">
                    <label for="" style="font-size: 30px; margin-left: 10px; margin-bottom: 10px">Add Group :</label>   
                    <select name="l_type" style="width: 30%;  height: 30px; font-size: 20px; margin-top: 5px; margin-left: 5px; ">
                  ...
                  <p>
                    <label for="">&nbsp;</label>
                    <button type="submit" name="submit" class="button_d_pass button_d2">Add Group</button>
                  </p>
                  </div> 
