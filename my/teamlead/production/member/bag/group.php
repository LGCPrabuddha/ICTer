...
<?php 
  ...
  $mem_list = '';
  $query = "SELECT * FROM signup,login WHERE login.ugroup='bag' AND login.email=signup.email AND signup.is_deleted = 0 ORDER BY signup.user_name";
          ...
          <div class="left-main">
            ...
            <?php echo date("d/m/y"); ?></h1> <!-- ccc -->
              ...
              <div style="width: 800px;" class="process" id="process-heading">
                <h3>Bag Quotation Group Members</h3>
                    <main>
                      <table class="mhTable">
                        <tr>
                          <th>Name</th>
