...
<?php 
  ...
  $mem_list = '';
  $query = "SELECT * FROM signup,login WHERE login.ugroup='publicity' AND login.email=signup.email AND signup.is_deleted = 0 ORDER BY signup.user_name";
