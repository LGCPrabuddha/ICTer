...
*/
      ...
      $query = "INSERT INTO tsponsorship (";
            ...
            <form method="POST" action="test2.php">
              ...
              <main>
                <form action="test2.php" method="post" class="userform">
                  ...
                  <p>
                    <label for="" class="enter_d" style="margin-left: 60px;">lindex:</label>
                  ...
                  <p>
                    ...
                    <input type="text" name="v2" placeholder="Index" style="width: 20%; margin-left: 20px; height: 30px; font-size: 18px;" <?php echo 'value="' .$v2. '"'; ?>>
                  </p>

                  <p>
                    <label for="" class="enter_d" style="margin-left: 60px;">assdate</label>
                    <input type="text" name="v3" placeholder="User name" style="width: 20%; margin-left: 20px; height: 30px; font-size: 18px;" <?php echo 'value="' .$v3. '"'; ?>>
                  </p>
                  <p>
                    <label for="" class="enter_d" style="margin-left: 60px;">enddate:</label>
                    <input type="text" name="v4" placeholder="User name" style="width: 20%; margin-left: 20px; height: 30px; font-size: 18px;" <?php echo 'value="' .$v4. '"'; ?>>
                  </p>


                  <p>
                    <label for="" class="enter_d" style="margin-left: 60px;">uindex:</label>
