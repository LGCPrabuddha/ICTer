...
if (isset($_POST['submit'])){ //added by me
    ...
    $query="INSERT INTO paper VALUES({$paper},'{$content}',{$review},'{$acceptance}','{$comment}')";
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><div class="form-group">
                                        ...
                                        <input type="text" name="paper" class="form-control" id="content" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <input type="text" name="content" class="form-control" id="comment" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <input type="text" name="review" class="form-control" id="paper" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <input type="text" name="comment" class="form-control" id="review" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <select name="status" id="stat" class="form-control">
                                            <option value="n">Not Reviewed</option>
                                            <option value="sa">Reviewed</option></select>
                                    </div></td>
