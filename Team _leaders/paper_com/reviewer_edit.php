...
if (isset($_POST['submit'])){ //added by me
    ...
    $query= "UPDATE reviewer_detail SET rid=$rid,  name='{$name}',
      email='{$email}', institute='{$institute}' WHERE rid=$code ";
...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <body>
            <form action="reviewer_edit.php" method="post">
                <div class="container">
                    ...
                    $query1="SELECT * FROM reviewer_detail WHERE rid='$code1'";
