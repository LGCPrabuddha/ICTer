       ...
       if ($result_set && $result_set1) {
        ...
        if (mysqli_num_rows($result_set) == 1) {
          ...
          if ($table == "admin") {
            ...
            switch ($group) {
              case 'sponsorship':
                header('Location:leaders/sponsorship/hleader.php');
                break;

              case 'keynote':
                header('Location:leaders/keynote/hleader.php');
                break;

              case 'publicity':
                header('Location:leaders/publicity/hleader.php');
                break;

                //for Udara and Rishoban******************************************

              // case 'paper':
              //   header('Location:leaders/paper/hleader.php');
              //   break;
              ...
              case 'hotel':
                header('Location:leaders/hotel/hleader.php');
                break;
              ...
              case 'bag':
                header('Location:leaders/bag/hleader.php');
                break;
