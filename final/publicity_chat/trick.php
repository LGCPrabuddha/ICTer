...
$sql1="SELECT commity FROM namelist WHERE name='$my_user'";
...
<html lang="en">
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                 ...
                 <span class="badge bg-green" id="del">1</span>
                  </a>
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
      <!-- lllll -->              <li><a href="javascript:;">Help</a></li>
                  </ul>
                  <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
  ...
  <div class="over">
    <div class="chatbox">
      <div class="chathead">
        <h3><?php $com=mysqli_query($connection,$sql1); while($rec=mysqli_fetch_assoc($com)){ echo $rec['commity'];}   ?></h3>
      </div>
      <div class="chatlog">
