...
if(isset($_POST['submit'])){
    ...
    $due_date=$_POST['date'];
    //$status=$_POST['date'];
    $inadd="INSERT INTO dbdsponsorship (mid, task, description,status, due_date) Values 
...
$result=mysqli_query($connection,"SELECT * FROM dbdsponsorship");
  ...
  <body class="nav-md">
    <div class="container body">
     ...
     <!-- page content -->
        ...
        <?php
        $userq="SELECT user_name,uindex FROM login WHERE ugroup = 'sponsorship' AND profile_type= 'member' ;";
