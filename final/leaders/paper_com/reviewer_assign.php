...
if (isset($_POST['submit'])){ //added by me
    ...
    $query="INSERT INTO reviewer_assign VALUES({$paper},{$reviewer},'{$comment}','{$status}','{$acceptance}')";
    $test = mysqli_query($connection,$query);
    if ($test) {
        # code...
        echo "ok";
    }
    header('Location:reviewer_assign.php');
}
?>
...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <body>
            <form action="reviewer_assign.php" method="post">
                <div class="container">
                    <h2><b>Assigning reviewers for the paper</b></h2>
                    <p>Assign the reviewr below</p>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><div class="form-group">
                                        ...
                                        <input type="text" name="paper" class="form-control" id="paper" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <input type="text" name="reviewer" class="form-control" id="reviewer" placeholder="Enter email">
                                    </div></td>
                                <td><div class="form-group">

                                        <input type="text" name="comment" class="form-control" id=comment" placeholder="Enter email">
                                    </div></td>
                                ...
                                <td><div class="form-group">
                                        ...
                                        <select name="status" id="stat" class="form-control">
                                            ...
                                            <option value="Reviewed">Reviewed</option></select>
                                    </div></td>

                                <td><div class="form-group">

                                        <select name="acceptance" id="accpt" class="form-control">
                                            <option value="-">-</option>
                                            <option value="Strongly Accepatance">Strongly Accepted</option>
                                            <option value="Weakly Accepatance">Weakly Accepted</option>
            ...
            <div class="container">
                <table class="table">
                    <thead>
                    <tr><td>Paper</td><td>reviewer</td><td>comment</td><td>status</td><td>acceptence</td><tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    while($row=mysqli_fetch_array($result)){
                        $code = $row['pid'];
                        echo "<tr><td><a href='viewPaper.php?code=$code'>".$row['pid']."</a></td><td><a href=\"Review_list.php\">".$row['rid']."</a></td><td>".$row['comment']."</td><td>".$row['status']."</td><td>".$row['accpt']."</td></tr>";
