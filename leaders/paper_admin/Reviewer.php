    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="container">
                <table class="table">
                    <thead>
                     <tr><td>Name</td><td>Institute</td><td>Email</td><tr>
                   </thead>
                    <tbody>
                    <?php

                    $query1="SELECT * FROM reviewer_detail WHERE rid='$Reviewer'";
                    $result=mysqli_query($connection,$query1);
                    while($row=mysqli_fetch_array($result)){
                        
                        echo "<tr><td>".$row['name']."</td><td>".$row['institute']."</a></td><td>".$row['email']."</td></tr>";
