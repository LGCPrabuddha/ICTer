...
if (isset($_POST['submit'])){ //added by me
    ...
    $query="INSERT INTO paper_detail VALUES($pid,'$content','$author','$institute')";
        ...
        <div class="right_col" role="main">
            ...
            <div class="container">
                <table class="table">
                    ...
                    $query1="SELECT * FROM paper_detail WHERE pid=$paper";
            ...
            <div class="container">
                ...
                <table class="table">
                    <thead>
                     <tr><td>Reviewer</td><td>Comment</td><td>Status</td><td>Acceptance</td><tr>
                   </thead>
                    <tbody>
                    	<?php
                    $query1="SELECT * FROM reviewer_assign WHERE pid='$paper'";
                    $result=mysqli_query($connection,$query1);
                    while($row=mysqli_fetch_array($result)){
                    
                        $code = $row['rid'];
                        echo "<tr><td><a href='Reviewer.php?code=$code'>".$row['rid']."</a></td><td>".$row['comment']."</a></td><td>".$row['status']."</td><td>".$row['accpt']."</td></tr>";
 }
