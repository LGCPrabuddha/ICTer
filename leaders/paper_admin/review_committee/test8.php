                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="hmembers.php"><i class="fa fa-edit"></i> Reviewed Papers <span class="fa fa-chevron-down"></span></a>
...
<div class="">
  ...
  <?php
                    ...
                    $query1="SELECT * FROM reviewer_detail where rid='$code'";
            ...
            <form >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="pid" id="pid" <?php echo 'value="'.$name.'"';    ?> disabled="">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Abstract</label>
                 <textarea class="form-control" rows="10" name="abstract" id="abstract" value="hjhfvhjv" disabled=""><?php echo "$institute"; ?></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Keyword</label>
                 <textarea class="form-control" rows="5" name="keyword" id="keyword" <?php echo 'value="'.$email.'"';    ?> disabled=""><?php echo "$email"; ?></textarea>
                </div>
