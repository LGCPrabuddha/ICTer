            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="publicitydb.php"><i class="fa fa-table"></i> Committee Database<span class="fa fa-chevron-down"></span></a>
            ...
            <div class="row top_tiles">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    $result=mysqli_query($connection,"SELECT * FROM login WHERE ugroup = 'publicity' AND profile_type= 'member' ");
                    ?>
                    <h1>Publicity Group Members</h1>
