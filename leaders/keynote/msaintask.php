...
if(isset($_POST['submit'])){
    ...
    $due_date=$_POST['date'];
    //$status=$_POST['date'];
    $inadd="INSERT INTO dbdkeynote (mid, task, description,status, due_date) Values 
...
$result=mysqli_query($connection,"SELECT * FROM dbdkeynote");
  ...
  <body class="nav-md">
    <div class="container body">
     ...
     <!-- page content -->
        ...
        <?php
        $userq="SELECT user_name,uindex FROM login WHERE ugroup = 'keynote' AND profile_type= 'member' ;";
