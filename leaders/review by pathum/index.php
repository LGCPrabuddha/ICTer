...
<?php 
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($_POST['pro_type']=="admin" && $_POST['password']=="ucsc@123") {
      // methanin balanna ona group create krlda kyla karalanam hleader.php nattan group rrate krna php file ekata 
      
      $_SESSION['email'] = $user['email'];
      $_SESSION['user_name'] = $user['user_name'];

      //to check the whether event is created for this year or not
      $date=date("Y");

        $query="SELECT year FROM event WHERE year = {$date}";
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="POST" action="index.php">
              ...
              <div>
                <input type="email" name="email" class="form-control" placeholder="Email Address" required="" value="<?php if (isset($_POST['email'])) echo $_POST['email']; else echo "Icter@gmail.com"?>"/>
              </div>
              <div>
